...
- ## [用GWT开发前端的团队多吗，为什么？ - 知乎](https://www.zhihu.com/question/35141108/answers/updated)
- GWT真的垃圾，又卡又慢
- 开发速度，和目前的前端框架技术简直没法比，毕竟是个淘汰了的东西
  - 如果你想开发一个动态交互的页面，也许只需要一点html和一个vue就能够很好地解决。但是如果你用GWT来开发的话就不是这么简单了，因为你需要等待漫长的编译时间，比如我每天至少要花一半的时间在GWT上，编译... 看效果... 编译如此反复 。
