...
- 对于包含相等数字但顺序不同的序列，构建的bst形态可以是不同的，如退化成链表
...
- 特殊的BST
  - bst/avl/rbt，数据量越大，深度越深，由于要加载到内存，io次数越多
  - 使用b-tree降低深度

- [据说红黑树很难理解，看动画5分钟就弄明白原理，它不严格的具有平衡属性](https://www.bilibili.com/video/BV1zU4y1H77f/)
...
- 每个节点最多有m个子节点，最多有m-1个关键字，关键字用来确定子树的位置/顺序
- 所有叶节点都在同一层，是平衡树
...
- 是一种特殊的二叉搜索树，每次查找后对树进行重构，把被查找的节点搬到离树根更近的地方。
# ref
