...
- clacky如何介入团队开发，需要改变团队的工作流
  - 哪些任务应该分给clacky，哪些自己干
- devin能给人技能提升的感受
  - clacky只是解决需求和issue，和用户的交流
  - 现在的感受是替代cursor, 需要改变哪些习惯，有哪些代价
  - 但clacky的设计是共生不是替代, onboarding时醒目的提醒用户
- thread的产品设计符合分支的概念
  - 但用户onboarding时感受不到分支的对应关系

- 用户转化率大盘，需要区分用户的玩具项目、生产项目，转化类型的区分方便精细化运营及产品优化
  - 用户导入生产级的项目才是有效产品的转化，体验各种项目demo不算有效
