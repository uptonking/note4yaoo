---
title: dev-log-2024
tags: [dev-log, dev-xp, stage-2024, yearly]
created: 2025-02-04T16:55:16.220Z
modified: 2025-02-04T16:55:20.632Z
---
...
- 昨天
  - 与意如确定cde布局空间优化的细节
  - 进行体验测试，初始化很顺利，处理issue的action规划还行
  - 处理临时反馈的一些issues
- 今天
  - 修复体验测试反馈的高优先级issues
  - 处理在terminal输入时光标意外跳入编辑器的问题
...
- 昨天
  - 基本上完成了快捷键功能的增强，特别是windows系统下的操作体验
  - 还处理了cde文件树或驾驶舱显示隐藏时的宽度异常问题
- 今天
  - 处理驾驶舱悬浮时的宽度异常问题
  - 优化打字动画的时机
  - 继续集中修复cde相关的issues
