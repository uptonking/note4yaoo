...
- xp
  ...
  - 🛒 购买日期202507，💣 摔坏日期202
  - 省电模式下会强制使用4G网络而不是5G，这会导致电话信号不好，退出省电模式就行
...
- [AGM X6 正式发布，该款手机有何亮点？ - 知乎](https://www.zhihu.com/question/656797316)
  - 2024 年 5 月 21 日，AGM 以线上直播的形式，正式发布了 AGM X 系列的最新产品——AGM X6 系列手机。
  - AGM 重新设计的 X6 的减震和防护结构，用「玄铁」结构替代了过去的防摔结构。简单来说，X6 采用了极为结实的金属中框，并在关键位置加入了额外的外层吸能结构
  - 考虑到 X6 的目标使用场景、LCD 的高亮度和 60Hz 带来的长续航远比「丰富对比度」和高刷新率来的有意义。
- 
