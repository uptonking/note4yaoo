...
- ## 飞书多维表格 正在吞噬 轻量化办公、任务、项目、学习类app的生存空间
- https://x.com/python_xxt/status/1993158236552470733
- 这个之前是真的好用，但是直接ai写套系统管理自动化程度更高，有可能vibecoding会吞噬飞书多维表格

- 它产品确实有这能力。只是我观察下来，大多数听说它很厉害但Excel都玩不明白的普通白领，真的就把它用成了Excel。所有字段手填，还抱怨怎么不能合并单元格。真的能用出这些能力的人，起码得有点数据库开发和数据分析背景。

- 并不会，功能太臃肿了，代表着空间占用率很高，操作更加复杂，学习成本会更高，想要学习的、正在办公的只会寻找更加简单的工具，比如右键新建Microsoft Excel工作簿
# discuss
- ## 
