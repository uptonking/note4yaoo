...
- ## 把自己的想法写出来的时候，因为要把各种数据和素材组织起来，写着写着就会发现自己的观点自然改变，或者得出新的结论。
- https://twitter.com/Svwang1/status/1631774474914922497
  - 所以我在社交媒体上的发言，主要是帮助自己思考用的 (而不是给别人看的)，同时微观上每一步推导争取获得外界有益的反馈，帮自己更好的思考。

- ## 我一直比较奇怪，为什么AI发展这么久，还是没有出现AI驱动的UI设计工具？按理说这么多现实世界的UI界面可学习，交互元素又简单（相比文字和艺术作品），风格又高度统一，应该更容易才对？
- https://twitter.com/TooooooBug/status/1600388902837264384

- ## 看到一个很牛逼的 Github 洞察工具「OSS Insight」，通过分析 Github 50多亿事件，提供了实时查看和分析 GitHub 趋势的能力，
- https://twitter.com/HiTw93/status/1600278921982844928
  - 可以发现很多好玩的东西，不局限于看整体开源趋势、对比分析项目和开发者、可视化的方式实时 GitHub贡献洞察、GitHub 2022 总结等等
