...
- ## [关于公益站的一点构建、运营经验 _202602](https://linux.do/t/topic/1671928)
  - 首先需要说明的是，现在不是一个开公益站的好时候，得益于注册机的泛滥，站内公益站的数量简直是井喷，让人眼花缭乱。
  - 并不需要多高的配置，绝大部分公益站使用的都是newapi，内存占用不会超过2GB，2c4g的服务器足矣，甚至前期，1c2g也是足够的。
  - 当然，如果真的能做到上万用户的规模，甚至像薄荷那样出圈，可能就比较复杂了，到那时候，你自然会学习如何运维和解耦。
  - 先说主站，一般都是newapi, 或者各种魔改newapi，接下来说渠道。
  - 一般开公益站，手上都是有点账号资源的，比如几十万的gpt普号，krio等等，这时候就需要号池和代理池（可选）。 目前主流的有 gpt-load sub2api CPA 等等
  - 当然，像黑与白、薄荷，还有额外的福利站什么的，这个另说, 这需要coding能力，甚至一个小团队，不是oneman可以做成的，一个人会很累。
  - 我的建议是：完全的解耦，一台服务器上只跑一个服务，分散开来，避免互相抢夺cpu和磁盘读写。
  - 主站（newapi）放在环亚太地区，香港、日本、新加坡，都可以，套上cf或者cdn什么的。
  - 渠道可以放在美西、加拿大，或者任何地区，国际互连一般是比较稳定，不像国内，金子般的带宽。
  - 我的操作就是，主站放新加坡，渠道放洛杉矶。

- ## [怒了兄弟们，服务器资源到底都被谁吃了？ ](https://linux.do/t/topic/1666978)
  - 这几天社区流量是出奇的高，相信各位佬友也感受出来了，差不多要高出年前工作日的 50% 。这吓得我赶紧拉防御，最后不得不在昨天进行了服务器扩容。
  - 但是效果甚微，我发现刚加的机器，加完就吃完。这还了得，你知道硬件涨价之后，现在服务器有多贵吗？？？
  - 我立刻开写风控系统，看看这些资源到底都被谁吃了。结果我直接怒了，这都是些啥？？？
  - 服务器合着都被脚本给吃了！
  - 于是我趁热打铁，追加了更多数据维度和风控操作。包括但不限于发警告私信、踢出登录，更多功能也在迭代中，势必把脚本给压下去。
  - 把自动脚本关一关吧，特别是批量操作、有定时功能的。
  - 另外，收到警告私信，你最好能及时回复，否则无法解释你一边在线嗷嗷访问，一边对警告视若无睹。

- 还有这日志猫猫看上去像是爬虫 / 采集工具吧，脚本不至于不停刷 json 接口吧 
  - 还有 1s 能访问这么多主题嘛，都像 ddos 了

- 会不会是被龙虾吃了
  - 还真有可能，前几天看到有佬友发帖，发图展示他通过龙虾自动监控特定关键词的帖子，还让其在抽奖帖子下回复
# discuss-known
- ## 
