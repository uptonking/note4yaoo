...
- ## [如今各大Coding-CLI官方自带的远程操作都已经成熟起来，自己开发远程的还有必要吗？ - LINUX DO _202605](https://linux.do/t/topic/2212892/6)
  - 主要是想在自己的VPS上部署，毕竟已经是一台丰富的开发机器，但是有几个缺点，重复配置模型、有的需要开正价才支持远程，然后我个人是用OpenCode比较多的，但是有的时候又想用CC和Codex，安卓版本现在的ChatGPT-APP不支持远程控制服务器
- 主流的都支持了的，opencode 支持的，我平时也在用，你看帖子的界面截图，

- 站里佬开发的AionUi，也可以远程操作， AionUi还支持通过webui或channels进行远程控制，因此，它也解决了我出门逛街的时候也想让电脑里的Agent牛马们好好打工的需求。

- 感觉从来都没必要，难道有更新还要追更新？ 直接 ssh/rdp 才是王道，随便整个云电脑当跳板机就能多端随便登了

- 一直用安卓termux的codex cc 好像远程没什么场景可以用到, 自己开发是不是考虑不做同质化的远程遥控. 试试垂直场景看看呢
