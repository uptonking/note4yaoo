...
- ## [为什么9929这么受欢迎 _202608](https://www.nodeseek.com/post-901904-1)
  - 为什么同样的单网，cmin2不如9929受欢迎？

- 9929兼顾电信联通，cmin2只兼顾移动。

- 因为移动跨网q得太狠，电信联通都还好

- 超售厉害，跨网没9929好用

- 因为tri现在没货，溢价也高，所以次选9929

- ## [国内大厂dns解析平台 只有华为云的可以分线路解析了吧. _202608](https://www.nodeseek.com/post-899496-1)
  - 我指的是免费套餐用户
  - 阿里云和腾讯云的dns解析, 免费用户能分线路解析, 但是把国内线路给禁了
  - 只有华为云不仅能分线路, 还分的细
- 直接华为国际，确实好用

- 因为你用的国际版，国内免费版阿里腾讯都是可以单国内的
- 腾讯云可以分境内境外啊
# discuss-dns
- ## 
...
- ## [腾讯云现在是不是不强制接入备案了 _202608](https://www.nodeseek.com/post-896980-1)
  - 我好几个域名是阿里云备案的，在腾讯云轻量都可以用，也没被拦截，是不是现在腾讯云不强制接入备案了？

- 阿里云备案的腾讯云可以用，腾讯云备案的阿里云不行
- 阿里云的严的很，没有北岸的机器，几乎所有的可用证书端口都over，我之前用了好几种方案都没法绕过去

- 没检查到就不拦截 我的腾讯国内服务器之前放了个服务好久 突然某天才被拦截警告的
