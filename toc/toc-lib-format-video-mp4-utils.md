...
# record
- https://github.com/webadderallorg/Recordly /14kStar/AGPL/202605/ts
  - https://recordly.dev/
  - Recordly is an open-source screen recorder and editor for walkthroughs, demos, product videos, and more. Accepting PRs.
# more
