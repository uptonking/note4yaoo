...
- https://github.com/opendatalab/OmniDocBench /apache2/202412/python
  ...
  - OmniDocBench is designed for Document Parsing, featuring rich annotations for evaluation across several dimensions:
    - End-to-end evaluation, 端到端评测：包括end2end和md2md两种评测方式, 端到端评测是对模型在PDF页面内容解析上的精度作出的评测。以模型输出的对整个PDF页面解析结果的Markdown作为Prediction。
    - Layout detection
    - Table recognition
    - Formula recognition
    - Text OCR
  - Currently supported metrics include:
    ...
    - TEDS
    - COCODet (mAP, mAR, etc.)
  - This benchmark includes 981 PDF pages, covering 9 document types, 4 layout types, and 3 language types. 
  - This benchmark includes 981 PDF pages, covering 9 document types, 4 layout types, and 3 language types. 
