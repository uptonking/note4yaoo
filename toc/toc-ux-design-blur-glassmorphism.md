...
- https://github.com/aleebaba3594/Glassmorphism-Website-Design-in-HTML-and-CSS
  - https://aleebaba3594.github.io/Glassmorphism-Website-Design-in-HTML-and-CSS/
  - Glassmorphism is the combination of two words "Glass" and "Morphism". 

- https://github.com/LuanEdCosta/react-tailwindcss-glassmorphism /
  - https://luanedcosta.github.io/react-tailwindcss-glassmorphism/
  - uses Tailwind CSS to design a glassmorphism based portfolio website.
- https://github.com/PanduKonala/Open-Source-Student-Portfolio-Design-Template
  - responsive portfolio template 

- https://github.com/MainakRepositor/Calendar /202105/js/表格可参考
  - https://calendar-mc.netlify.app/
  - simple javascript calendar with a glassmorphic UI
  - https://github.com/Thiagoow/Web-Calendar-Glassmorphic-Design-UX-UI

- https://github.com/beatrizsabbatini/glassmorphism-study
  - Layout Responsivo

- https://github.com/devendrakarpe/Glassmorphism-ui-desgin
  - To create the glassmorphism effect, you should use `backdrop-filter: blur()` . 

- https://github.com/dominique-mueller/ui-components-with-blur-experiment
  - Using a blur effect for the visual design of UI components.
  - Using the CSS `backdrop-filter` property, we can add a blur effect behind semi-transparent areas, such as panels or buttons.

- https://github.com/shubham44-code/Glassmorphism-Design-CSS
  - https://htmlpreview.github.io/?https://github.com/shubham44-code/Glassmorphism-Design-CSS/blob/main/index.html
  - Glassmorphism Design CSS || HTML CSS JS

- https://github.com/hicodersofficial/glassmorphism-login-form
  - https://codepen.io/hicoders/pen/eYdwVmb
  - Glassmorphism login Page

- https://github.com/Firespindash/Blurred-UI
  - A project to learn how to make blur effect in most html elements without frameworks.

- https://github.com/gabrieldejesus/glassmorphism
  - https://gabrieldejesus.github.io/glassmorphism
  - 毛玻璃卡片，带有跟随鼠标位置倾斜的效果
- https://github.com/Amani-dot/GLASSMORPHISM-CARD-
  - GLASSMORPHISM CARD HOVER ANIMATION
  - 毛玻璃卡片，无倾斜效果

- https://github.com/HadiKia/loginGlass /蓝色登录页
  - https://htmlpreview.github.io/?https://github.com/HadiKia/loginGlass/blob/master/index.html
- https://github.com/Varshithvhegde/profilecard
  - https://varshithvhegde.live/
...
- https://github.com/Uzcoin404/Rate-us
