...
- 传统色-bookmarks
  - 传统色很少用蓝色
  - 铅白: #f0f0f4(网红)   银白: #e9e6f1(黄仁达)  经典背景色: #fafafa/#eee
...
- ## Gray: #808080 /黑白灰
  ...
  - 铅白(国画颜料/white-lead): #f0f0f4(网红--有点灰) #fffcf0(黄仁达--偏黄)
  - 银白: #e9e7ef(网红--偏灰紫) #e9e6f1(黄仁达) #f1f0ed(色谱--有点黄) #EBE5D5(王定理--偏黄) #cdd1d3(银鱼白-色谱--青灰)
  - 凝脂: #e7e7e7(满庭芳--暗灰偏青) #F5F2E9(郭浩--偏黄)
  - 米色: #eeead9 #f9e9cd(色谱) #E9E6C5(王定理)
  - 鱼肚白: #f7f4ed(色谱--偏黄) #cdd1d3(银鱼白-色谱) #fcefe8(网红)
  - 瓷白: #FFFFFB(黄仁达--淡黄灰)
  - 雪白: #FFFEF9(色谱--淡黄) #f2fdff(网红)
...
- ## Red: #ff0000 /红紫
  ...
  - 胭脂/燕脂(装扮、国画颜料/carmine): #952E3A(王定理) #9d2933(网红) #b32142(满庭芳) #C25160(郭浩) #f03f24(色谱)
  ...
  - 丁香(lilac): #cca4e3(满庭芳) #ce93b4(郭浩) #e9d7df(色谱) #695776(王定理)
...
- ## Yellow: #ffff00 /黄棕褐
  ...
  - 杏黄(apricot): #f28e16(色谱) #f7e8aa(杏仁黄-色谱) #f8bc31(初熟杏黄-色谱) #DA9233(杏子-郭浩) #ffa631(网红) #ff8c31(杏红-网红)
...
- ## Green: #008000 ~~#00ff00~~ /绿葱
  ...
  - 铜绿(verdigris): #2bae85(色谱) #549688  #533c1b(古铜绿-色谱) #79b7a5(黄仁达) 
  - 艾绿: #CAD3C3(色谱) #a99e3b(黄仁达) #a4e2c6(画师)
  - 对比: #008080 🤔teal
  - 翠绿: #006E5F(王定理) #20a162(色谱) #c6dfc8(淡翠绿)
  - 翡翠(jadeite): #006870(黄仁达) #3DE1AD(画师) 
  - 吉翠: #2b6868(满庭芳)
...
- ## Blue: #0000ff /青+蓝
  ...
  - deepskyblue: #00bfff
  - cyan/aqua: #00ffff
  - 群青(ultramarine): #133d7e(满庭芳) #2E59A7(郭浩) #1772b4(色谱) #084495(王定理) #4c8dae(网红) #5666b8(网红)
  ...
  - 孔雀蓝(peacock-blue): #4994C4(郭浩) #0eb0c9(色谱) #0041A5(王定理) #2b2680(黄仁达)
...
- 国风设计参考，传统色+布局
  ...
  - [国色官网 - 传统颜色 ](https://zhongguose.com/)
...
- https://github.com/nevertoday/zhongguo-traditional-colors /926Star/MIT/202606/js
  ...
  - https://github.com/nevertoday/zhongguo-traditional-colors/blob/main/docs/chinese-color-harmony.csv
  - https://github.com/nevertoday/zhongguo-traditional-colors/blob/main/docs/chinese-color-harmony.md
  - https://x.com/xiaoxiaodong01/status/2064010953897939015
    - 每个颜色：推导出同类、邻近、互补、分裂互补、三角、四角、冷暖、明暗、灰调、中性色及主辅点缀等配色
...
- you don’t need that many colours.
