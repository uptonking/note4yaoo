...
- Gray: #808080 /黑白灰
  ...
  - 青骊: #000013
  - 银灰: #918072(色谱) #acb8be(黄仁达) #c1b2a3(淡银灰-色谱)
  - 草灰: #675B46(王定理)
  - 铅灰: #BBB5AC(色谱)
  - 珍珠灰: #E4DFD7(色谱)
...
- Red: #ff0000 /红紫
  ...
  - 胭脂/燕脂(装扮、国画颜料): #952E3A(王定理) #9d2933 #b32142(满庭芳) #f03f24(色谱) 
  ...
  - 青莲紫: #95509F(王定理) #8b2671(色谱) #bd669e(黄仁达) #801dae(偏蓝的紫-网红)
...
- Green: #008000 ~~#00ff00~~ /绿翠
  ...
  - 葱绿: #9ed900 #A0C777(黄仁达) #9ebc19(画师)
  - 苍翠: #519a73
  - 青翠: #298A7C(黄仁达)
  - 葱黄: #a3d900 
  - 碧绿: #2add9c
...
- Blue: #0000ff /青+蓝
  ...
  - 孔雀蓝: #0041A5(王定理) #4994C4(郭浩) #0eb0c9(色谱) #2b2680(黄仁达)
