...
- ## ⚡️🤔 [How to Compress transactions - discuss. CodeMirror _202409](https://discuss.codemirror.net/t/how-to-compress-transactions/8624)
  - I’m using the collab feature from CodeMirror and I’m saving the transactions in one of my DBs. 
  - I’m running into an issue where the amount of data being read and stored into my DB is excessive(过多的，过分的；极度的) and I’m trying to see how to cut back. 
