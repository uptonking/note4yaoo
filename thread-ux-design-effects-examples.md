...
- 有一个 Figma 插件，如果你用 Figma 的话
  - 试了, 不够好.  只能简单调整边框, 好像不能设置阴影.

- 如果是做截图并且在 Mac 上的话，系统自带的预览应用的编辑就有这功能
  - 苹果自带的“预览”里就可以直接超级模式里加放大镜

- keynote有这个效果…

- 剪映 特效放大镜

- 一个div，宽高一致，radius- full，就是个圆，然后圆里背景是这个页面，调整位置，放大，然后overflow设置hidden，最后加个阴影。其他软件一样操作，都是内容叠加，然后放大一个，挪位置，明天试下做个脚本

- figma 加一张图，叠在上面，放大，裁切成圆形。缺点是手动；优点是缩放多少都可以自己控制。
