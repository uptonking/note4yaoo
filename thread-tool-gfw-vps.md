...
- ## 其实不止手机，路由器目前也是禁止刷机的。工信部在管。之前某品牌默认开放telnet，可以直接刷uboot，然后工信部要求新版本系统关掉这个telnet端口，新版本系统不能降级到旧版本系统。
- https://x.com/milycious/status/2031507964339814558
  - 具体是哪个我就不说了，只能说是一个mt798x的机子。
- 其实不止路由器禁止刷机。最近我在办理新装宽带，师傅说不给自备光猫（强迫给我一个新的光猫），不给桥接帐号拨号上网，我问了一下，他说如果使用软路由拨号上网会被判断虚假宽带。

- 我这里移动光猫默认连upnp都不开了，之前打游戏挂了加速器都怪怪的，直到某天突发奇想解锁了光猫进去一看，擦！upnp都是关掉的！然后光猫还有个啥后台控件一直在运行，按进程名判断应该链接移动后台的. 具体作用懒得研究了

- 那是因为你用的移动或者联通，一分钱一分货的事情。电信出厂就自带公网ip，拨号账户和密码直接贴你光猫上。我名下三条宽带都是这样。昨天想办第四条专门用于mc开服，一问政策还是一样没变。
  - 我去年办的电信，可以自己拨号，但是想要公网的话要200块钱以上的套餐再加100才给

- 请问光猫桥接等有啥优势，小白知识盲区，能介绍下吗？
...
- ## [2核4G的服务器有啥用嘛？ - LINUX DO _202605](https://linux.do/t/topic/2249786)
- 只要不是吃资源的服务都可以~
我阿里云2c2G的已经续费多年了~
最多的时候跑了10多个服务~
wordpress个人博客、微信小程序后端、AI小agent、网盘、主页导航、各种python就不说了。。。
美西1c1g的跑着VPN、CPA、newapi、各种2api…但是是自用，人多了的确抗不住！

- 这么强的服务器可以扛得住很多项目的后端了，像是个人博客，个人网站，或者随便做的很多项目都可以放上面。还可以把自己的bot后端也放上面，qq bot的后端也可以放上面。像hermes和openclaw部署在上面，就可以搭建自己的私人助手了

- 很多用处了，内存那么大。我现在自建的sub2api中转，自己用，99个free帐号，内存就只用了73MB, 我只想说爽用，好吧。部署Hermes/龙虾+个人网页+grok2api+sub2api/cpa+自建代理节点+…

- 国内云的话，当frp，跑qq机器人，除此之外不多了
- 当作公网服务器，做内网穿透用，实际的程序运行在你的本地电脑，然后ssh转发端口到公网服务器

- 内网穿透，远程访问家里电脑。个人网页，个人云盘，个人导航，个人新闻信息聚合，个人视频等项目。酒馆，龙虾，N8N。阿里好象可以直接装宝塔，方便服务器管理。就这些吧，4g勉强够用！
# discuss
- ## 
